...
class NewsTableViewController: UITableViewController, XMLParserDelegate {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath){
        let newsdetailViewController = self.storyboard?.instantiateViewController(
            withIdentifier: "NewsDetailViewController") as! NewsDetailViewController
        
        newsdetailViewController.address = books[indexPath.row].link
        
        self.navigationController?.pushViewController(
            newsdetailViewController, animated: true)
